...
INSERT OR REPLACE INTO events (
  ...
  location_name, location_address, is_outdoor, lat, lon, created_at, updated_at
) VALUES
('ev1','calvarybible','campus_boulder','Starting Point','New to Calvary? A simple next step to learn more.',datetime('now','+7 days'),datetime('now','+7 days','+90 minutes'),'Boulder Campus','3245 Kalmia Ave. Boulder, CO 80301',0,40.0403,-105.2539,datetime('now'),datetime('now')),
('ev2','calvarybible','campus_boulder','Welcome Lunch','Meet pastors and new friends.',datetime('now','+14 days'),datetime('now','+14 days','+2 hours'),'Boulder Campus','3245 Kalmia Ave. Boulder, CO 80301',0,40.0403,-105.2539,datetime('now'),datetime('now')),
...
('ev_erie_candy_needed','calvarybible','campus_erie','Candy Needed!',
 ...
 'Erie Campus','615 Evans St. Erie, CO 80516',0,40.0506,-105.0496,datetime('now'),datetime('now')),
('ev_erie_easter_weekend','calvarybible','campus_erie','Easter Weekend',
 ...
 'Erie Campus','615 Evans St. Erie, CO 80516',1,40.0506,-105.0496,datetime('now'),datetime('now')),
('ev_erie_womens_away_retreat','calvarybible','campus_erie','Women''s Away Retreat',
 ...
 'YMCA of the Rockies','Estes Park, CO',0,40.0506,-105.0496,datetime('now'),datetime('now')),
...
('ev_boulder_candy_needed','calvarybible','campus_boulder','Candy Needed!',
 ...
 'Boulder Campus','3245 Kalmia Ave. Boulder, CO 80301',0,40.0403,-105.2539,datetime('now'),datetime('now')),
...
('ev_boulder_easter_weekend','calvarybible','campus_boulder','Easter Weekend',
 ...
 'Boulder Campus','3245 Kalmia Ave. Boulder, CO 80301',1,40.0403,-105.2539,datetime('now'),datetime('now')),
...
('ev_thornton_candy_needed','calvarybible','campus_thornton','Candy Needed!',
 'Please help fill treasure chests for the Easter Egg Hunt. Bring individually wrapped candy through March 15.',
 '2026-03-01T00:00:00','2026-03-15T23:59:00',
 'Thornton Campus','11989 St Paul St. Thornton, CO 80233',0,39.9183,-104.9453,datetime('now'),datetime('now')),
('ev_thornton_easter_weekend','calvarybible','campus_thornton','Easter Weekend',
 'Celebrate Easter with us! Good Friday (Apr 3), Egg Hunt (Apr 4), Easter Sunday (Apr 5). Learn more: https://calvarybible.com/easter',
 '2026-04-03T00:00:00','2026-04-05T23:59:00',
 'Thornton Campus','11989 St Paul St. Thornton, CO 80233',1,39.9183,-104.9453,datetime('now'),datetime('now')),
